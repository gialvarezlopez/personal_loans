...
class DefaultController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        */
        ...
        {
            $couCode = strtoupper($geo->country->couCode);
        }
        else
        {
            $couCode = "US";
        ...
        $cur = $this->currentLatLngUser( $couCode );
    ...
    public function currentLatLngUser( $couCode )
    {
        $em  = $this->getDoctrine()->getManager();
        ...
        if( $couCode != "" )
        {
            $result  =  $em->getRepository('AppBundle:Country')->findOneBy( array('couCode' => $couCode ) );
            if( $result )
            {
